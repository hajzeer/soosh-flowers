...
export default createGlobalStyle`
  :root {
    ...
    @font-face {
      ...
      font-style: normal;
      font-weight: 400;
      src: url('/fonts/Dream Avenue/Dream Avenue.ttf');
      font-display: fallback;
    }
    --font-family-main: "aileron", sans-serif;;
    ...
    /* Colors */
    --color-main-background: #A49988;
    --color-text-main: #5A393E;
    --color-text-sub: #F8F7F2;

    --color-box-background: #A49988;
